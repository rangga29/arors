                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        @can('create schedule dates')
                            <button type="button" class="btn btn-primary sd-add" data-bs-toggle="modal" data-bs-target="#add-modal" data-max-date="{{ $schedule_date_last }}">
                        ...
                        <table id="basic-datatable" class="table table-striped table-bordered table-centered dt-responsive nowrap w-100">
                            ...
                            @foreach($schedule_dates as $schedule_date)
                                <tr>
                                    ...
                                    <td>{{ \Carbon\Carbon::parse($schedule_date->sd_date)->isoFormat('DD MMMM YYYY') }}</td>
                                    <td>
