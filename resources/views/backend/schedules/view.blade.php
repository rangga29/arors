                    ...
                    <table id="basic-datatable" class="table table-striped table-bordered table-centered dt-responsive nowrap w-100">
                        ...
                        @foreach($schedules as $schedule)
                            <tr>
                                ...
                                <td>{{ $schedule->sc_counter_online_umum }}</td>
                                <td>{{ $schedule->sc_online_umum }}</td>
                                <td>{{ $schedule->sc_counter_online_bpjs }}</td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="ps-3 pe-3 mt-2 mb-4" action="#" method="POST" id="editQuota">
                        ...
                        <div class="mb-3">
                            <label for="edit_sc_online_umum" class="form-label">Kuota Pasien Umum</label>
                            <input type="number" class="form-control" name="sc_online_umum" id="edit_sc_online_umum" placeholder="Kuota Pasien Umum" required>
                        </div>
                        <div class="mb-3">
                            <label for="edit_sc_online_bpjs" class="form-label">Kuota Pasien BPJS</label>
                            <input type="number" class="form-control" name="sc_online_bpjs" id="edit_sc_online_bpjs" placeholder="Kuota Pasien BPJS" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">* Gunakan hanya jika kuota di Medinfras tidak bisa diubah atau kuota berubah mendadak.</label>
                            <label class="form-label">* Jika perubahan kuota bersifat permanen harus di ubah di Medinfras.</label>
                        </div>
