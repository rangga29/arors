<div>
    ...
    <form wire:submit.prevent="createAppointment">
        ...
        <div class="mb-3">
            <label for="no_skdp" class="form-label">No SKDP</label>
            <input type="text" class="form-control form-control-lg shadow border-0" name="no_skdp" id="no_skdp" wire:model="no_skdp" maxlength="6" placeholder="No SKDP" oninput="this.value = this.value.replace(/\D/g, '');" autocomplete>
        </div>
