...
<div class="content-container">
    ...
    <h2 class="title">REGISTRASI PASIEN BARU</h2>
...
<div class="container">
    <div class="row">
        <hr>
        <div class="items">
            <p><strong>NIK : </strong>{{ $detailPatientData['nap_ssn'] }}</p>
        </div>
        <div class="items">
            <p><strong>NAMA PASIEN : </strong>{{ $detailPatientData['nap_name'] }}</p>
        </div>
        <div class="items">
            <p><strong>TANGGAL LAHIR : </strong>{{ \Carbon\Carbon::createFromFormat('Y-m-d', $detailPatientData['nap_birthday'])->isoFormat('DD MMMM YYYY') }}</p>
        </div>
        <div class="items">
            <p><strong>ALAMAT : </strong>{{ $detailPatientData['nap_address'] }}</p>
        </div>
        <div class="items">
            <p><strong>EMAIL : </strong>{{ $detailPatientData['nap_email'] }}</p>
        </div>
        <div class="items">
            <p><strong>NO. HANDPHONE : </strong>{{ $detailPatientData['nap_phone'] }}</p>
        </div>
        <div class="items">
