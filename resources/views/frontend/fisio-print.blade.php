...
<div class="container">
    <div class="row">
        <hr>
        <div class="items">
            <p><strong>NORM : </strong>{{ $patientData['fap_norm'] }}</p>
        </div>
        <div class="items">
            <p><strong>NAMA PASIEN : </strong>{{ $patientData['fap_name'] }}</p>
        </div>
        <div class="items">
            <p><strong>TANGGAL LAHIR : </strong>{{ \Carbon\Carbon::createFromFormat('Y-m-d', $patientData['fap_birthday'])->isoFormat('DD MMMM YYYY') }}</p>
        </div>
        <div class="items">
