            ...
            if ($sc_date->sd_date < Carbon::today()->format('Y-m-d')) {
                ...
                foreach ($sc_all as $sc) {
                    $sc_data = ScheduleBackup::create([
                        ...
                        'scb_umum' => $sc->sc_umum,
                        'scb_bpjs' => $sc->sc_bpjs,
                        'scb_counter_max_umum' => $sc->sc_counter_max_umum,
                        'scb_max_umum' => $sc->sc_max_umum,
                        'scb_counter_max_bpjs' => $sc->sc_counter_max_bpjs,
                        'scb_max_bpjs' => $sc->sc_max_bpjs,
                        'scb_counter_online_umum' => $sc->sc_counter_online_umum,
                        'scb_online_umum' => $sc->sc_online_umum,
                        'scb_counter_online_bpjs' => $sc->sc_counter_online_bpjs,
                    ...
                    if (!empty($data['Data'])) {
                        ...
                        for ($x = 0; $x < count($dataField); $x++) {
                            ...
                            Schedule::create([
                                ...
                                'sc_counter_max_umum' => 0,
                                'sc_max_umum' => $dataField[$x]['PhysicianOperationalTime']['MaximumAppointmentNonBPJS1'],
                                'sc_counter_max_bpjs' => 0,
                                'sc_max_bpjs' => $dataField[$x]['PhysicianOperationalTime']['MaximumAppointmentBPJS1'],
                                'sc_counter_online_umum' => 0,
                                'sc_online_umum' => $dataField[$x]['PhysicianOperationalTime']['OnlineAppointmentNonBPJS1'],
                                'sc_counter_online_bpjs' => 0,
                                'sc_online_bpjs' => $dataField[$x]['PhysicianOperationalTime']['OnlineAppointmentBPJS1'],
                                'sc_available' => true,
